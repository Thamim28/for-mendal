...
import { Heart, ChefHat, X, Check, Utensils, RotateCcw } from 'lucide-react';
import { motion, useInView } from 'framer-motion';

interface QuizCookSectionProps {
    onConfetti: () => void;
    onComplete: () => void;
}

export default function QuizCookSection({ onConfetti, onComplete }: QuizCookSectionProps) {
        ...
        >
            ...
            >
                <div className="bg-white/70 p-4 rounded-2xl shadow-soft animate-gentle-bob">
                    <ChefHat className="w-10 h-10 text-valentine-red" />
                </div>
            </motion.div>
            ...
            >
                ...
                <div className="absolute -top-5 -left-5">
                    <Utensils className="w-12 h-12 text-valentine-red fill-valentine-red/10 animate-pulse" />
                </div>
                ...
                {!selectedAnswer ? (
                    ...
                    >
                        ...
                        <p className="font-nunito text-lg text-valentine-text-muted">
                            {selectedAnswer === 'me'
                                ? "Mendal's cooking = 5 star dining. 👨‍🍳✨"
